...
public class StringUtil {
	...
	/**
	 * 是否包含目标字符，如： contains("abcd","d") --> true ;  contains("abcd","e") --> false
	 * @param str
	 * @param searchChar
	 * @return
	 */
	...
	/**
	 * 是否包含目标字符并忽略大小写，如： contains("abcd","A") --> false ;  containsIgnoreCase("abcd","A") --> true
	 * @param str
	 * @param searchChar
	 * @return
	 */
	...
	/**
	 * 计算给定字符串中后者（单个字符）出现的次数，如：StringUtil.countRepStr("Tihe quick", "aeiou") --> 4
	 * @param src
	 * @param rep
	 * @return
	 */
	...
	/**
	 * 合并重复指定字符串（单个字符），如：StringUtil.squeezeRepStr("Thiie quuu uuick", "aeiou") --> Thie qu uick
	 * @param src
	 * @param rep
	 * @return
	 */
	...
	/**
	 * 比较字符串数组中不同字符的起始位置，如：indexOfDifference(new String[] {"i am a machine", "i am a robot"}) -> 7
	 * @param rep
	 * @param repcout
	 * @return
	 */
