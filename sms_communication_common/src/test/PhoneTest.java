...
public class PhoneTest {
    ...
    public void updateTest(String phone){
    	try {
            String sql = " UPDATE sms_send_task_phone SET state=100 WHERE sms_send_task_id IN (19966,19970,19971,19972,19974,19975,19977,19979,19982,19984) AND phone='" + phone+"'";
    ...
    public List<String> readPhoneData() {
    	File tempFile = new File("C:\\Users\\Administrator\\Desktop\\update-sql.txt");
