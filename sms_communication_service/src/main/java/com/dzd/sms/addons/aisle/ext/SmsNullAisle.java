...
public class SmsNullAisle extends BaseAisle {
    private  static Logger logger = Logger.getLogger(SmsNullAisle.class );
    public SmsNullAisle() {
        this.setAisleId( -4l );
...
//            smsSendResult.setState(Define.STATE_SENDED_NULL_ERROR);
...
//        return false;
        ...
        logger.info("SmsNullAisle sendSinglePackage state="+Define.STATE_SENDED_NULL_ERROR+" size="+mobileList.size());
        return false;
