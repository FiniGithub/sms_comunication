...
{
  private static final ResourceBundle bundle = ResourceBundle.getBundle("code/code_database");
  private static final ResourceBundle bundlePath = ResourceBundle.getBundle("code/code_config");
...
//  public static String URL = "jdbc:mysql://localhost:3306/sys?useUnicode=true&characterEncoding=UTF-8";
  public static String URL = "jdbc:mysql://150f08189u.iok.la:3306/dzd_template?useUnicode=true&amp;characterEncoding=utf-8";
  public static String USERNAME = "root";
  public static String PASSWORD = "test";
  public static String DATABASE_NAME = "dzd_template";
  ...
  public static String web_root_package = "web-root-none-config";
  public static String source_root_package = "src-none-config";
