...
<%@page import="com.dzd.phonebook.util.Pkipair"%>


<%
	//人民币网关账号，该账号为11位人民币网关商户编号+01,该参数必填。
	String merchantAcctId = "1002369702001";
	//编码方式，1代表 UTF-8; 2 代表 GBK; 3代表 GB2312 默认为1,该参数必填。
	String inputCharset = "1";
	//接收支付结果的页面地址，该参数一般置为空即可。(客户看到的页面)
	String pageUrl = "";
	//服务器接收支付结果的后台地址，该参数务必填写，不能为空。
	String bgUrl = "http://218.17.158.163:8899/sms_communication_web/pay/payCallBacks.do";
	//网关版本，固定值：v2.0,该参数必填。
	String version =  "v2.0";
	...
	String payerContact =  "786685410@qq.com";
	...
	String orderAmount = "1";//request.getAttribute("orderAmount").toString();
	//订单提交时间，格式：yyyyMMddHHmmss，如：20071117020101，不能为空。
	String orderTime = new java.text.SimpleDateFormat("yyyyMMddHHmmss").format(new java.util.Date());
	//商品名称，可以为空。
	String productName= "00"; 
	//商品数量，可以为空。
	String productNum = "1";
	//商品代码，可以为空。
	String productId = "1";
	//商品描述，可以为空。
	String productDesc = "00";
	...
	String bankId = request.getAttribute("bankId").toString();
...
<html>
	...
	<body onload="aotoSubmit()">
		...
		<div align="center" style="font-weight: bold;">
			...
			<!-- form name="kqPay" action="https://sandbox2.99bill.com/gateway/recvMerchantInfoAction.htm" method="post"-->
