...
<body>
	...
	<input type="hidden" id="path1" value="${ctx}">
	...
	<div class="com-content">
		<div class="com-menu inp-menu" style="text-align:center;">
           ...
           <div class="inp-box inpt-box-btn">
			     ...
			     <input id="time_input" class="inp-box-inp" type="text" placeholder="" />
            </div>
		...
		<div class="com-menu" style="padding-left:10px;color: #FD0000;">
			<span>提交短信</span>
