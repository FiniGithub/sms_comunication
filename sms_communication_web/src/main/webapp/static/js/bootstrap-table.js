! function(a) {
    ...
    o.DEFAULTS = {
        ...
        var f = this,
            g = [],
            i = this.getData(),ccext = this.options.ccext,lines = this.options.lines;
        if(lines==null || lines==""){
        	lines = 10;
        }
        ...
        for (var k = this.pageFrom - 1; k < this.pageTo; k++) {
            ...
            n._data && !a.isEmptyObject(n._data) && a.each(n._data, function(a, b) {
                ...
                if (x.visible) {
                    ...
                    if( ccext && "string" == typeof l && l.indexOf("!")>-1){
                    	var lindex =  l.indexOf("!");
                    	var content = l.substring(lindex + 1,l.length);
                    	l = l.substring(0,lindex);
                    	lext = content;
                    }
            ...
            }), this.options.cardView && g.push("</td>"), g.push("</tr>"), ccext && g.push("<tr><td colspan="+lines+" style='text-align:left'>"), ccext &&  g.push(lext), ccext &&  g.push("</td></tr>")
        }
