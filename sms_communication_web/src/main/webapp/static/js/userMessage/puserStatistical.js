...
$(function () {
	...
	var ksdate = getBeforeDate(6);
	$("#start_input").val(ksdate+" 00:00:00");
            ...
            },
            {
                ...
                formatter: function (value, row, index) {
            		if(index==0){
            			...
            			$("#i_fnum").html(row.sumSendNum);
            			$("#i_anum").html(row.sumSendNum);
                		$("#i_unum").html(row.sumConsumeMoney+"元");
                		$("#i_xfnum").html(row.sumExpectMoney+"元");
